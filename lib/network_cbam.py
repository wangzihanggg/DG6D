...
class PoseNetFeat(nn.Module):
    ...
    def forward(self, x, emb):
        x = F.relu(self.conv1(x))  #(1, 64, 1000)
        emb = F.relu(self.e_conv1(emb))  #(1, 64, 1000)
        pointfeat_1 = torch.cat((x, emb), dim=1)  #(1, 128, 1000)

        x = F.relu(self.conv2(x))  #(1, 128, 1000)
        emb = F.relu(self.e_conv2(emb))  #(1, 128, 1000)
        pointfeat_2 = torch.cat((x, emb), dim=1)  #(1, 256, 1000)

        x = F.relu(self.conv5(pointfeat_2))  #(1, 512, 1000)
        x = F.relu(self.conv6(x))  #(1, 1024, 1000)
        ap_x = self.ap(x)  #(1, 1024, 1)
