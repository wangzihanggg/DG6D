...
parser.add_argument('--dataset_root', default='/home/wangzihanggg/codespace/CMCL6D/datasets/ycb/YCB_Video_Dataset', help="dataset root dir (''YCB_Video Dataset'')")
...
if __name__ == '__main__':
    ...
    dataset = SegDataset(opt.dataset_root, '{0}/{1}'.format(opt.dataset_root, 'dataset_config/train_data_list.txt'), True, 268)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batch_size, shuffle=True, num_workers=int(opt.workers))
    test_dataset = SegDataset(opt.dataset_root, '{0}/{1}'.format(opt.dataset_root, 'dataset_config/train_data_list.txt'), False, 268)
